...
func (s *Scheduler) syncNodeGPUUsage(nodeID string, usage *NodeUsage) error {
	...
	if client.GetClient() == nil {
		klog.V(4).InfoS("Skip syncing GPU usage because Kubernetes client is not initialized", "node", nodeID)
		return nil
	}
